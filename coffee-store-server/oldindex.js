...
async function run() {
  try {
    ...
    app.get('/coffees', async (req, res) => {
      // const cursor = coffeeCollectin.find()
     ...
     app.get('/my-coffees/:email', async (req, res) => {
        ...
        app.patch('/like/:coffeeId', async(req, res)=>{
          ...
          const updatedDoc = alreadyLiked? {
            $pull:{    //disLike coffee (pop email from likedBy array)
              likedBy:email
            }
          } : {
            $addToSet:{      //Like coffee (push email in likedBy array)
              likedBy:email
            }
          }
